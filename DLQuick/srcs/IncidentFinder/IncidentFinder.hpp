...
# define MISSING_INCIDENTS_FILE_ERROR	"ReferenceFinder: Couldn't find " INCIDENTS_FILE ". It should be placed in the same folder as the executable."
	...
	public:
		...
		class	IFException : public std::exception
		{
			...
			public:
				...
				{
					std::cout << "ERROR GENERATED BY IFEXCEPTION" << std::endl;
